...
?>
<div class="col-lg-3 col-sm-6 col-12 dmt-35">
    <a href="<?php the_permalink(); ?>" class="single-shop-page d-flex justify-content-center align-items-end bg-white text-decoration-none w-100 radius30 transition p-5">
        <div>
            <div class="shop-card-img dmb-15 overflow-hidden d-flex justify-content-center align-items-center transition">
