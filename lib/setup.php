...
function assets()
{
  wp_enqueue_style('curious/css', Assets\asset_path('styles/main.css'), false, 'v12');

  if (is_single() && comments_open() && get_option('thread_comments')) {
    wp_enqueue_script('comment-reply');
  }

  wp_enqueue_script('curious/js', Assets\asset_path('scripts/main.js'), ['jquery'], 'v12', true);
}
